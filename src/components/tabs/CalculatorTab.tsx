                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor={`grommets-${window.id}`} className="text-gray-700 text-sm cursor-pointer">
                      Люверсы 16мм (40 ₽/шт) + Пластиковая клипса для крепления (45 ₽/шт)
                    </Label>
                  </div>
                  {window.grommets && (
                    <div className="ml-6">
                ...
                {window.area > 0 && (
                  <>
                    <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                      ...
                      <p className="text-gray-700 text-sm">
                        Общая площадь окна: <strong>{window.area.toFixed(2)} м²</strong>
                      </p>
                      <p className="text-gray-700 text-sm">
                        Площадь ПВХ (с припуском): <strong>{(((window.верх + 50) * (window.право + 50)) / 1000000).toFixed(2)} м²</strong>
                      </p>
                      {window.perimeter && (
                        <p className="text-gray-700 text-sm">
