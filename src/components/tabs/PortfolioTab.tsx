...
const PortfolioTab: React.FC = () => {
  ...
  const reviews = [
    { text: 'Отличное качество! Мягкие окна на террасе служат уже второй год. Никаких протечек, швы крепкие. Монтаж выполнили быстро и аккуратно.', author: 'Александр П.', location: 'Гатчинский район, ЛО', bg: 'bg-blue-50' },
    { text: 'Для нашего ресторана заказывали мягкие окна на летнюю веранду. Клиенты довольны - теперь можно сидеть даже в дождь. Рекомендую!', author: 'Елена В.', location: 'Всеволожский район, ЛО', bg: 'bg-green-50' },
    { text: 'Заказывали промышленные окна для склада. Размеры большие, но справились на отлично. Теперь товары защищены от дождя.', author: 'Михаил С.', location: 'Кировский район, ЛО', bg: 'bg-purple-50' },
    { text: 'Профессиональный подход! Сделали точные замеры, предложили оптимальное решение. Работают быстро и качественно.', author: 'Ольга К.', location: 'Выборгский район, ЛО', bg: 'bg-orange-50' },
    { text: 'Мягкие окна для яхт-клуба получились отличные! Выдерживают морской климат, соленый воздух. Очень довольны.', author: 'Дмитрий Н.', location: 'Приозерский район, ЛО', bg: 'bg-indigo-50' },
    { text: 'Заказываем уже не первый раз. Качество стабильно высокое, цены адекватные. Лучшая компания в регионе!', author: 'Сергей Т.', location: 'Ломоносовский район, ЛО', bg: 'bg-pink-50' }
  ];
