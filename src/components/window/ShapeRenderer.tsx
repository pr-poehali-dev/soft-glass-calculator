  ...
  if (shape === 'rectangle') {
    return (
      <svg width="900" height="680" viewBox="0 0 450 400" className="border rounded bg-white blueprint-svg">
        ...
        <line x1="355" y1="84" x2="355" y2="216" stroke="#22C55E" strokeWidth="1.5" strokeDasharray="5,3"/>
        <line x1="352" y1="84" x2="358" y2="84" stroke="#22C55E" strokeWidth="1.5"/>
        ...
        <line x1="352" y1="216" x2="358" y2="216" stroke="#22C55E" strokeWidth="1.5"/>
